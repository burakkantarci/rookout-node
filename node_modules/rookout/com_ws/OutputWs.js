...
var _AgentComWs = require("./AgentComWs.js");
...
class OutputWs {
  ...
  addMessage(ruleId, message) {
    // The validation is on the envelope the message is wrapped by,
    // but the user is warned of his message length and not the envelope length
    // because the message is more related to the user's raw data
