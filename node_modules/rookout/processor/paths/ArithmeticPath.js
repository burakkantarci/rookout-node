...
class Opt extends Marker {
  ...
  executeOperation(a, b) {
    switch (this.level) {
      ...
      case 2:
      case 4:
        debug_log("comparing: " + a.get_obj() + " to " + b.get_obj());
...
class actions {
  ...
  make_and_execute_namespace_operation(input, start, end, elements) {
    ...
    try {
      ...
      debug_log("done reading namespace: " + result.obj);
...
class ArithmeticPath {
  constructor(configuration) {
    let whitelistedModules = process.env.ROOKOUT_DEBUG_CONDITION;
